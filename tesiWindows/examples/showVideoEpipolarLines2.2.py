...
for it in range(100):
  ...
  cv2.imwrite('output' + os.path.sep + 'flow' + os.path.sep + '0%09d.jpg'%it, flowCorrect)

  #collage0 = np.concatenate((left,disp0, kpold, img5, flowCorrect),1)
  #collage1 = np.concatenate((flow_color.astype(np.uint8),disp1, kpleft, img3, flowCorrect),1)
